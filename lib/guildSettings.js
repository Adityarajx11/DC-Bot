...
async function getGuildSettings(guildId) {
  try {
    ...
    return {
      ...
      greetingVoiceChannelId: row.greeting_voice_channel_id,
      greetingMemberRoleId: row.greeting_member_role_id,
...
async function updateGuildSettings(guildId, patch) {
  try {
    ...
    const mappings = {
      ...
      greetingVoiceChannelId: 'greeting_voice_channel_id',
      greetingMemberRoleId: 'greeting_member_role_id',
      stay247: 'stay_247',
